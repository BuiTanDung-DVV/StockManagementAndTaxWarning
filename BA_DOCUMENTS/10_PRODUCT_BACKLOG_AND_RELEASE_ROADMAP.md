...
| Kỳ chi phí/lương và chốt ca | Đã sửa local: cùng `from/to` cho tổng/danh sách, lọc lương server-side, ô tiền thực tế nullable; backend P0 55/55 và Flutter toàn bộ 61/61 đạt | Chưa đóng P0-17/21/22 cho tới khi deploy và chạy TC-FIN-04/05/06 trên production |
