  ...
  void _showDisclaimer(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Text('Miễn trừ trách nhiệm', style: GoogleFonts.outfit(fontWeight: FontWeight.bold, color: c.textPrimary, fontSize: 18)),
        content: Text(
        ...
        actions: [
          TextButton(
            ...
            child: Text('Đã hiểu', style: GoogleFonts.inter(color: c.textSecondary, fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
          ...
          children: [
                ...
                Expanded(
                  child: Text(
                    ...
                    style: GoogleFonts.outfit(
                      ...
                      color: AppColors.warning.withBlue(0).withGreen(100), // Tăng contrast cho A11Y
                    ),
                  ),
                ),
                IconButton(
                  icon: Icon(Icons.info_outline, color: AppColors.warning.withBlue(0).withGreen(100)),
                  onPressed: () => _showDisclaimer(context),
                  tooltip: 'Xem miễn trừ trách nhiệm',
                  constraints: const BoxConstraints(minWidth: 48, minHeight: 48), // Chuẩn A11Y
            ...
            Container(
              ...
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Icon(Icons.lightbulb_outline, size: 16, color: AppColors.warning.withBlue(0).withGreen(100)),
                  const SizedBox(width: 8),
                  Expanded(
                    child: Text(
                      'Chú ý: Nếu doanh thu < 100 triệu VNĐ/năm, hộ kinh doanh có thể được miễn thuế. Hệ thống chỉ hỗ trợ tính toán dự kiến.',
                      style: TextStyle(fontStyle: FontStyle.italic, color: c.textSecondary, fontSize: 12),
                    ),
                  ),
                ],
              ),
  ...
  Widget _buildRow(String label, String value, AppThemeColors c) {
    return Row(
      ...
      children: [
        ...
        Text(value, style: GoogleFonts.outfit(fontWeight: FontWeight.bold, color: c.textPrimary, fontSize: 14)),
      ],
    );
  }
}
