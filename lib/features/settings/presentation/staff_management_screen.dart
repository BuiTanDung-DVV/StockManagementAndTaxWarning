...
class _StaffManagementScreenState extends ConsumerState<StaffManagementScreen> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<int>(
                    ...
                    decoration: InputDecoration(
                      labelText: 'Vai trò *',
                      prefixIcon: Icon(Icons.shield_outlined, color: c.textMuted, size: 20),
                      filled: true,
          ...
          builder: (ctx, setDlg) => AlertDialog(
            ...
            actions: [
              ...
              ElevatedButton(
                ...
                child: Text('Lưu', style: GoogleFonts.outfit(fontWeight: FontWeight.bold)),
              ),
            ],
          ),
        );
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton.extended(
          ...
          label: Text('Thêm nhân viên', style: GoogleFonts.outfit(fontWeight: FontWeight.bold)),
          backgroundColor: theme.colorScheme.primary,
          foregroundColor: Colors.white,
          elevation: 0,
        ),
                        ...
                        ? ListView(
                            ...
                            children: const [
                              ...
                              AppEmpty(
                                ...
                                subtitle: 'Nhấn "Thêm nhân viên" để thêm trực tiếp',
                              ),
                            ],
                          )
                        : ListView.separated(
                            ...
                            itemBuilder: (_, i) => _buildMemberCard(_members[i], c, theme),
                          ),
                  ),
                        ...
                        ? ListView(
                            ...
                            children: const [
                              ...
                              AppEmpty(
                                ...
                                subtitle: 'Nhân viên mới điền mã shop sẽ xuất hiện tại đây',
                              ),
                            ],
                          )
                        : ListView.separated(
                            ...
                            separatorBuilder: (_, _) => const SizedBox(height: 12),
                            itemBuilder: (_, i) => _buildPendingCard(_pendingMembers[i], c, theme),
                          ),
                  ),
                ],
              ),
  ...
  Widget _buildMemberCard(Map<String, dynamic> m, AppThemeColors c, ThemeData theme) {
      ...
      child: Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(
            ...
            style: GoogleFonts.outfit(fontWeight: FontWeight.bold, fontSize: 15, color: c.textPrimary)
          ),
          const SizedBox(height: 2),
          Text('@${m['username'] ?? ''}', style: GoogleFonts.inter(fontSize: 12, color: c.textMuted)),
          ...
          Container(
            ...
            child: Text(
              roleName, 
              style: GoogleFonts.inter(fontSize: 11, fontWeight: FontWeight.w600, color: isOwner ? theme.colorScheme.primary : AppColors.info),
            ),
          ),
        ])),
        if (!isOwner) ...[
  ...
  Widget _buildPendingCard(Map<String, dynamic> m, AppThemeColors c, ThemeData theme) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: c.card,
      ...
      child: Row(
        children: [
          Container(
            ...
            alignment: Alignment.center,
            child: Text(
              (m['fullName']?.isNotEmpty == true ? m['fullName'][0] : (m['username']?.isNotEmpty == true ? m['username'][0] : '?')).toString().toUpperCase(),
          ...
          Row(
            ...
            children: [
              IconButton(
                icon: const Icon(Icons.check_circle_outline_rounded, color: AppColors.success, size: 24),
                tooltip: 'Duyệt',
                onPressed: () => _handlePendingDecision(m, approve: true),
              ),
              IconButton(
                icon: const Icon(Icons.cancel_outlined, color: AppColors.danger, size: 24),
                tooltip: 'Từ chối',
...
class _RoleConfigScreenState extends ConsumerState<RoleConfigScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        icon: const Icon(Icons.shield_outlined),
        label: Text('Tạo vai trò mới', style: GoogleFonts.outfit(fontWeight: FontWeight.bold)),
        backgroundColor: theme.colorScheme.primary,
        foregroundColor: Colors.white,
        elevation: 0,
      ),
  ...
  Widget _buildRoleCard(Map<String, dynamic> role, AppThemeColors c, ThemeData theme) {
          ...
          Row(
            children: [
              Container(
                ...
                child: Icon(Icons.shield_rounded, color: theme.colorScheme.primary, size: 20),
              ),
              ...
              children: activePerms.map((e) {
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(8),
                    border: Border.all(
                      color: isFull ? AppColors.success.withValues(alpha: 0.15) : AppColors.info.withValues(alpha: 0.15),
                    ),
                  ),
                  child: Text(
                    '$label: $level',
