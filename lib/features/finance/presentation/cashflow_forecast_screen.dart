  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          Text(
                                            f['forecastDate']?.toString().split('T').first ?? '', 
                              ...
                              Row(
                                children: [
                                  Container(
                                    ...
                                    child: Icon(Icons.pie_chart_outline_rounded, size: 16, color: theme.colorScheme.primary),
                                  ),
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(
                                      fontSize: 12, 
                                      fontWeight: FontWeight.bold,
                                      color: isFullyAchieved ? AppColors.success : AppColors.warning
                                    )
                                  ),
                                ],
                              ),
                                ...
                                child: Container(
                                  ...
                                  child: Align(
                                    ...
                                    child: AnimatedContainer(
                                      ...
                                      width: MediaQuery.of(context).size.width * 0.8 * pct.clamp(0, 1).toDouble(),
                                      decoration: BoxDecoration(
                                        borderRadius: BorderRadius.circular(6),
                                        gradient: LinearGradient(
                                          colors: [
                                            theme.colorScheme.primary,
                                            isFullyAchieved ? AppColors.success : theme.colorScheme.primary.withValues(alpha: 0.7),
                                          ],
                                        ),
                                      ),
                                    ),
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(
                                      fontSize: 12, 
                                      fontWeight: FontWeight.bold,
                                      color: actualExpense <= plannedExpense ? AppColors.success : AppColors.danger
                                    )
                                  ),
                                ],
                              ),
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () => _showAddForecastDialog(context, ref),
        icon: const Icon(Icons.trending_up_rounded),
        label: Text('Thêm dự báo', style: GoogleFonts.outfit(fontWeight: FontWeight.bold)),
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: const Icon(Icons.arrow_downward_rounded, color: AppColors.success),
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: const Icon(Icons.arrow_upward_rounded, color: AppColors.danger),
                  contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
                  enabledBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(16),
                    borderSide: BorderSide(color: c.divider.withValues(alpha: 0.6)),
