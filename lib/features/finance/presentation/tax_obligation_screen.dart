...
class TaxObligationScreen extends ConsumerWidget {
  ...
  void _showEditDialog(
    ...
    final vatC = TextEditingController(
      text: asNum(t['vatDeclared']).toString(),
    );
    final pitC = TextEditingController(
      text: asNum(t['pitDeclared']).toString(),
    );
    final vatPaidC = TextEditingController(
      text: asNum(t['vatPaid']).toString(),
    );
    final pitPaidC = TextEditingController(
      text: asNum(t['pitPaid']).toString(),
    );
          ...
          content: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  controller: vatC,
                  decoration: const InputDecoration(labelText: 'VAT khai nộp'),
                  keyboardType: TextInputType.number,
                ),
                TextField(
                  controller: pitC,
                  decoration: const InputDecoration(labelText: 'TNCN khai nộp'),
                  keyboardType: TextInputType.number,
                ),
                const SizedBox(height: 8),
                TextField(
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: statuses
                      ...
                      .toList(),
                  onChanged: (v) =>
                      setDlg(() => selectedStatus = v ?? selectedStatus),
                ),
              ],
            ),
          ),
