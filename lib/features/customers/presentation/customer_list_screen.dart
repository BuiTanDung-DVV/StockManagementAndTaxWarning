  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        elevation: 0,
        actions: [featureGuideButton(context, 'customer_list')],
      ),
        ...
        data: (data) {
          ...
          if (items.isEmpty) {
            return const AppEmpty(
              ...
              subtitle:
                  'Hãy thêm khách hàng đầu tiên để bắt đầu lưu trữ giao dịch',
            );
          }
          return Column(
            children: [
                  ...
                  child: RefreshIndicator(
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (_, i) {
                        final cust = items[i];
                        final debt = asDouble(
                          cust['totalDebt'] ?? cust['balance'],
                        );
                        final initialChar = (cust['name'] ?? 'K')[0]
                            .toUpperCase();
