...
let SupplierController = class SupplierController {
    ...
    async update(id, dto) { return response_1.ApiResponse.ok(await this.svc.update(id, dto)); }
    async payables(id) { return response_1.ApiResponse.ok(await this.svc.findPayables(id)); }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], SupplierController.prototype, "payables", null);
